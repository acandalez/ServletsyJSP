...
import examples.val.JSF.answer.services.DepartmentServices;
...
public class Departamentos implements Serializable {
	...
	public void init() {
		...
		listaDepartamentos = departmentServices.obtenerListaDepartamentos(); // departamentServices
																				// es
																				// ya
																				// un
																				// objeto
	...
	public String actionEmpleados() {
		...
		// selected); //esto también funcionaría ;)
