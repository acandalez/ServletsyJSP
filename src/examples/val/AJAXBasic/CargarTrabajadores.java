...
public class CargarTrabajadores extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			rs = st.executeQuery("select first_name from employees where department_id = "
					+ department_id);
			...
			while (rs.next()) {
				...
				out.println("<empleado>" + rs.getString(3) + "</empleado>");
				out.println("<empleado>" + rs.getString(4) + "</empleado>");
			}
			out.println("</empleados>");
